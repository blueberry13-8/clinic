...
mixin _$PatientState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Patient> items, int? selectedIndex) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Patient> items, int? selectedIndex)? success,
...
abstract class Loading implements PatientState {
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Patient> items, int? selectedIndex});
}
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(
      {final List<Patient> items = const [], this.selectedIndex})
      : _items = items;
  ...
  @override
  String toString() {
    return 'PatientState.success(items: $items, selectedIndex: $selectedIndex)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_items), selectedIndex);
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(items, selectedIndex);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(items, selectedIndex);
  }
...
abstract class Success implements PatientState {
  const factory Success({final List<Patient> items, final int? selectedIndex}) =
      _$SuccessImpl;
...
abstract class Error implements PatientState {
