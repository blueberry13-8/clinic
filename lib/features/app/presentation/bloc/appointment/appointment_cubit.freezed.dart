...
mixin _$AppointmentState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Appointment> items, int? selectedIndex)
        success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Appointment> items, int? selectedIndex)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Appointment> items, int? selectedIndex});
}
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(
      {final List<Appointment> items = const [], this.selectedIndex})
      : _items = items;
  ...
  @override
  String toString() {
    return 'AppointmentState.success(items: $items, selectedIndex: $selectedIndex)';
  }
